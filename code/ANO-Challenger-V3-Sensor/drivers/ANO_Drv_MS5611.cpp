...
void ANO_MS5611::Reset(void)
{
    I2C_Single_Write(MS5611_ADDR, CMD_RESET, 1);
}

bool ANO_MS5611::Read_Prom(void)
{
	uint8_t rxbuf[2] = { 0, 0 };
	u8 check = 0;
...
void ANO_MS5611::BaroAltCalculate(void)
{
...
int32_t ANO_MS5611::Get_BaroAlt(void)
{
	return baroAlt;
}
